...
SELECT CompanyName, City FROM Customers WHERE Country = 'Mexico';
...
SELECT CompanyName, City, Country FROM Customers WHERE City IN ('Berlin', 'Madrid', 'London') ORDER BY City;